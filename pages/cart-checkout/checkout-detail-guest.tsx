...
export default function Checkoutdetailguest() {
    return (
        ...
        <div>
            ...
            <div className="ml-16 flex flex-row mb-8">
                <div className="text-lg font-light leading-loose mr-1">Have an account?</div>
                <div className="text-lg font-light leading-loose text-gray-moreinfo"><a href="/login">Login</a></div>
            </div>
            ...
            <div>
                ...
                <div className="flex flex-col lg:flex-row container mx-auto mb-16 lg:mb-36">
                    ...
                    <div className="mr-9 w-full lg:w-full mb-10 lg:mb-0">
                        <div className="leading-loose text-2xl font-normal mb-14">SHIPPING ADDRESS</div>
                        <form action="">
                      ...
                      outline-none">
                            ...
                            <div>
                                ...
                                <div className="flex items-center mb-8">
                                    ...
                                    <label className="text-lg font-light leading-loose text-black ml-2 block">
                                        Mobile banking
                                    </label>
                                </div>
